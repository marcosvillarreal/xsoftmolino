...
cLogoCtacte	= SYS(5)+CURDIR()+"logoregctacte.jpg"
...
*-- RUTA
   ...
   _rutaformcae  =lcdd+'forms\facelectronica'
    cLogoCtacte	= _rutabmps + '\logoregctacte.jpg'
...
ObjReporter.AddProperty('filelogo',"logoreport.jpg")
ObjReporter.AddProperty('logoregctacte',cLogoCtacte)
...
*!*		      ENDIF 
	...
	*--------------------------   
	...
	Do Form frmmenu With 'datamenu','seguridad','favoritos',Pidsistema
