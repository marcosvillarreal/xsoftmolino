...
llok = CargarTabla(lcbdd,'Chofer',.t.)
llok = CargarTabla(lcbdd,'Camion',.t.)
...
lnidcanalvta = RecuperarID('CsrCanalVta',Goapp.sucursal10)
INSERT INTO CsrCanalVta (id,numero,nombre,limitecred,minimofac,plazo,descuento,lista) ;
VALUES (lnidcanalvta,1,"SIN ESPECIFICAR",0,0,0,0,0)
...
,lnctabanco,lnctaotro,lnidplanpago,lnsaldo,lnsaldoant,lnestadocta,lnbonif1,lnbonif2;
...
SCAN 
	...
	,lnctabanco,lnctaotro,lnctaorden,lnidplanpago,lnsaldo,lnsaldoant,lnestadocta;
   ...
   STORE "" TO lccnumero,lccnombre,lccdireccion,lccpostal,lcctelefono2,lcctelefono,lcemail,lccuit;
    ...
    STORE 1 TO 	lnctadeudor,lnlista,lnctaacreedor
	...
	SELECT CsrLocalidad
	LOCATE FOR VAL(cpostal) = VAL(cCodPostal)
	IF FOUND()
