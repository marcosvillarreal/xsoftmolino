...
USE ALLTRIM(lcpath)+"\CONTAB\cuen0145" IN 0 ALIAS FsrCuenta01 EXCLUSIVE 
...
*!*						ENDIF 
	...
	lncuenta = lncuenta 	&&CsrCuentaX.numero
...
INSERT INTO CsrPlanCue(id,cuenta,nombre,imputable,idmadre,madre,orden,idclase,tipocuenta,codigo,idejercicio,idejeantes);
values (lnid,lnCuenta,'COMPRA DE MERCADERIA VARIA',1,67,67,20,9,4,"",1,0)
lnid = lnid +1 
lnCuenta = lnCuenta + 1 
INSERT INTO CsrPlanCue(id,cuenta,nombre,imputable,idmadre,madre,orden,idclase,tipocuenta,codigo,idejercicio,idejeantes);
values(lnid,lnCuenta,"VENTA DE MERCADERIA VARIA",1,66,66,20,9,5,"",1,0)
