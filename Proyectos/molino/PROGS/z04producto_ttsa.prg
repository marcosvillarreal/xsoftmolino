...
USE ALLTRIM(lcpath )+"\gestion\tablaiva" IN 0 ALIAS FsrTablaIVA EXCLUSIVE
...
*!*	    ENDIF
	...
	SELECT FsrTablaIVA
	LOCATE FOR numero = Fsrarticulo.tablaiva
	SELECT CsrTipoiva
	LOCATE FOR tasa=FsrTablaIVA.ivari
	...
	lnmargen1 = IIF(FsrArticulo.utilidad>999.99,999.99,FsrArticulo.utilidad)
	lnmargen2 = IIF(FsrArticulo.utilidad2>999.99,999.99,FsrArticulo.utilidad2)
	lnmargen3 = IIF(FsrArticulo.utilidad3>999.99,999.99,FsrArticulo.utilidad3)
	...
	*Una vez caragdo todos los productos, recorremos los que idenvase#0 y buscamos el articulo = envase.
	...
	IF DefaultVar('FsrArticulo.perceib',"")$'S' OR DefaultVar('FsrArticulo.llevaib',"")$'S'
		SELECT CsrProvincia
		GO TOP 
		SCAN 
