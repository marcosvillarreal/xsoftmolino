...
llok = CargarTabla(lcData,'CanalVta')
...
SCAN 
   ...
   STORE "" TO lccnumero,lccnombre,lccdireccion,lccpostal,lcctelefono2,lcctelefono,lcemail,lccuit;
	...
	lccnombre		= ALLTRIM(IIF(EMPTY(FsrBanco.banco),FsrBanco.nombre,FsrBanco.banco))+ALLTRIM(FsrBanco.numero)
	lccdireccion	= ""
	lccpostal		= ""
	lcctelefono		= ""
	lcemail			= ""
