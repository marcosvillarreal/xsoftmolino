...
USE ALLTRIM(lcpath)+"\contab\cuen0147" IN 0 ALIAS FsrCuenta01 EXCLUSIVE 
...
*!*						ENDIF 
	...
	INSERT INTO CsrPlanCue (id,cuenta,nombre,imputable,idmadre,madre,orden,idclase,tipocuenta,codigo,idejercicio,idejeantes,switch);
	VALUES (lnidentificador,lncuenta,lcnombre,lnimputable,lnidmadre,lcmadre,lnorden,lnidclase,lntipocuenta,lccodigo,lnidejercicio,lnidejeantes,'00000')
...
INSERT INTO CsrPlanCue(id,cuenta,nombre,imputable,idmadre,madre,orden,idclase,tipocuenta,codigo,idejercicio,idejeantes,switch);
values (lnid,lnCuenta,'COMPRA DE MERCADERIA VARIA',1,67,67,20,9,4,"",goapp.idejercicio,0,'00000')
lnid = lnid +1 
lnCuenta = lnCuenta +1
INSERT INTO CsrPlanCue(id,cuenta,nombre,imputable,idmadre,madre,orden,idclase,tipocuenta,codigo,idejercicio,idejeantes,switch);
values(lnid,lnCuenta,"VENTA DE MERCADERIA VARIA",1,66,66,20,9,5,"",goapp.idejercicio,0,'00000')
...
GO TOP 
SCAN 
	STORE 0 TO lnidplanacre ,lnidplandeu ,lnidplanbco ,lnidplanfactu ,lnidplanCAJA;
		,lnidclase ,lnregisa ,lnregisd ,lnregisb ,	lnregisf ,lnregisK
